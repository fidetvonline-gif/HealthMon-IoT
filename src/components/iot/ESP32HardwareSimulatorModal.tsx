  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/70 p-4 backdrop-blur-xs overflow-y-auto">
      <div className="relative w-full max-w-5xl rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden my-8">
        {/* Modal Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 bg-slate-50/80 px-6 py-4 gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-slate-900">ESP32 IoT Hardware & IP Link Bench</h3>
                <span className="rounded-md bg-blue-100 px-2 py-0.5 text-xs font-semibold text-blue-700">
                  V4 Physio Spec
                </span>
              </div>
              <p className="text-xs text-slate-500">
                Simulate sensors or connect directly to your physical ESP32-C3 device via IP address (`/api/data`).
              </p>
            </div>
          </div>
        ...
        <div className="flex border-b border-slate-200 bg-slate-100/70 px-6">
          <button
            type="button"
          ...
          >
            ...
            <span>Interactive Sensor Simulator</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span>ESP32-C3 V4 IP Device Link (`/api/data`)</span>
          </button>
        </div>
